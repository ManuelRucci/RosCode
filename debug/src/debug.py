...
# Options: DEBU, INFO, WARN, ERROR, FATAL
rospy.init_node('debug_node', log_level=rospy.DEBUG)
rate = rospy.Rate(0.5)

# In Kinetic ROS you can use this periodic log publication. We are useing Indigo here, so not useable yet.
